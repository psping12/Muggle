...
import com.example.ps.muggle.BuildConfig;
import com.example.ps.muggle.app.Constants;
import com.example.ps.muggle.di.qualifier.MyUrl;
import com.example.ps.muggle.http.DecodeConverterFactory;
import com.example.ps.muggle.http.api.MyApis;
import com.example.ps.muggle.utils.SystemUtil;
...
//        builder.addInterceptor(apikey);
    ...
    @Singleton
    @Provides
    MyApis provideMyApis(@MyUrl Retrofit retrofit) {
